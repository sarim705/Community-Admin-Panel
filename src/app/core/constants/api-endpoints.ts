...
public GET_ALL_TYFCBS:string=`${this.PATH}/tyfcbs/getAllTyfcb`
public GET_ALL_VISITORS:string=`${this.PATH}/users/event/getAllVisitors`
public UPDATE_VISITOR:string=`${this.PATH}/users/event/updateVisitor`
