...
export class EventsComponent implements OnInit, AfterViewInit {
  ...
  qrEventName: string = '';
  chapters: Chapter[] = []; // Store chapters for dropdown
  selectedChapter: string = 'All'; // Default to 'All' for chapter dropdown
  ...
  newEvent = {
    ...
    chapter_name: 'All' // Added chapter_name field, default to 'All'
  };
  ...
  ngOnInit(): void {
    this.fetchEvents();
    this.fetchChapters(); // Fetch chapters for dropdown
  }
  ...
  canSaveEvent(): boolean {
    return !!this.newEvent.name &&
           ...
           !!this.newEvent.date &&
           !!this.thumbnailFile &&
           !!this.newEvent.location && // Require location
           !!this.newEvent.chapter_name; // Require chapter_name
  }
  ...
  async saveEvent(): Promise<void> {
    try {
      ...
      formData.append('location', this.newEvent.location); // Add location
      if (this.newEvent.chapter_name !== 'All') {
        formData.append('chapter_name', this.newEvent.chapter_name); // Add chapter_name if not 'All'
      }
